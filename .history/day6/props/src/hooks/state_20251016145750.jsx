  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input type="radio" name='department' value={form.department === 'HR'}/>HR
        <input type="radio" name='department' value={form.department === 'sales'}/>Sales
        <input type="radio" name='department' value={form.department === 'marketing'}/>Marketing <br />
