  ...
  return (
    ...
    <div className='aboutinter'> 
      <div className='about-i'>
        ...
        <div>
          <ul>
            <li> Developed a full-stack web application with Patient and Doctor Dashboards, Notification System, Medical Records, Calendar View, and Prescription Handling.
            </li>
            <li>Collaborated with the team to design and deploy the company’s official website, improving UI/UX
                and load performance.
            </li>
