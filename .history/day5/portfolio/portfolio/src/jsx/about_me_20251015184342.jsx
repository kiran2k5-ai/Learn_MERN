      ...
      <div className='about-i'>
        ...
        <div>
          <ul>
            ...
            <li>Built responsive interfaces using TypeScript, integrated backend and database with Supabase, and implemented email notifications via Twilio for seamless communication.
            </li>
            <li>Worked with Git/GitHub for version control and debugged frontend components to enhance
                reliability.
            </li>
