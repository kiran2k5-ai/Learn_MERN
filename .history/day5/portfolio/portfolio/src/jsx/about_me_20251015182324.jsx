  ...
  return (
    <>
      <div className='about'>
        ...
        <div>
          <ul>
          <li></li> Developed and maintained responsive web interfaces using HTML5, CSS3, JavaScript, and
Bootstrap.
•Collaborated with the team to design and deploy the company’s official website, improving UI/UX
and load performance.
•Worked with Git/GitHub for version control and debugged frontend components to enhance
reliability.
•Gained exposure to backend development concepts, API integration, and database handling.
          </ul>
        </div>
      </div>
      <hr className='line'/>
