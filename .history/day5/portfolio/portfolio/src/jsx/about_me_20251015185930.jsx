...
const about_me = () => {
  return (
    <>
      <div className='about'>
        ...
        <div className='about-jj1'>
          ...
          <h4 className='about-jj-date'> 11/06/2025 to 21/06/2025</h4>
        </div>
        <div>
          <ul>
    ...
    <div className='aboutinter'> 
      <div className='about-i'>
        ...
        <div className='about-jj2'>
          ...
          <h4 className='about-jj-date'> 25.07.2025 to 18.08.2025 </h4>
        </div>
        <div>
          <ul>
    ...
    <div className="education">
      ...
      <div>
        <span className='educationbatch'>Bachelor of Engineering</span> <br />
        Sri Shakthi Institute of Engineering and Technology, Coimbatore
        BE-CSE / CGPA: 8.12
      </div>
      <div>
        <span className='educationbatch'>SBOA CBSE School, Madurai</span> <br />
         HSC - 84 % <br />
         SSLC - 80 %
      </div>
    </div>
