    ...
    <>
      ...
      <div>
        ...
        <p className='aboutp'>I am Kiran P, a passionate and dedicated individual with a strong 
          ...
          In addition to my technical skills, I am a team player and thrive in collaborative environments. I am excited about the opportunities to contribute my knowledge and skills to real-world projects and make a positive impact through technology.</p>
      </div>
    </>
  )
}
