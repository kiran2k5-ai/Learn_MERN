    ...
    <div>
      <nav className='navbar'>
        ...
        <div className='links'>
            ...
            <Link to ='/techstack' className='link-a'>TechStack</Link>
            <a href='/project' className='link-a'>Project</a>
            ...
            <a href="https://leetcode.com/u/KIRANPALANIR/" target='_blanck'><img className="image-a" src="https://cdn-icons-png.flaticon.com/128/984/984196.png" alt="LeetCode" /></a>
        </div>
      </nav>
    </div>
  )
